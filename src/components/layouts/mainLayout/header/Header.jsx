...
export default function Header() {
  ...
  return (
    <header className="Header py-2 bg-white fixed top-0 z-10 w-full">
      <div>
        <div className="justify-between lg:items-center lg:flex px-6 py-3">
          <div>
            <div className="flex items-center justify-between lg:block">
              <NavLink to="home">
                <div className="flex justify-center items-center">
                  <img className="w-10" src="/icon.png" alt="" />
                  <p className="text-xl font-bold ">yberM</p>
                </div>
              </NavLink>
              ...
              <div className="mt-3 space-x-2 lg:hidden ">
                {nguoiDung ? (
                  ...
                  <div className="inline-block space-x-2">
                    ...
                    <NavLink
                      to="/user/register"
                      className="inline-block px-4 py-2 text-black bg-dark rounded-md shadow hover:bg-gray-500 hover:text-white transition duration-300"
                    >
                      Đăng kí
                    </NavLink>
                  </div>
            ...
            {nguoiDung ? (
              <div className="inline-block space-x-2">
                ...
                <button
                  ...
                  className="inline-block px-4 py-2 text-black bg-white rounded-md shadow hover:bg-gray-500 hover:text-white transition duration-300 border border-yellow-500"
                >
                  Đăng xuất
                </button>
                {nguoiDung.maLoaiNguoiDung === "QuanTri" ? (
              ...
              <div className="inline-block space-x-2">
                ...
                <NavLink
                  to="/user/register"
                  className="inline-block px-4 py-2 text-black bg-gray rounded-md shadow hover:bg-gray-500 hover:text-white transition duration-300"
                >
                  Đăng kí
                </NavLink>
              </div>
